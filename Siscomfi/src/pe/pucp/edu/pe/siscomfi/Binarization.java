...
public class Binarization {
	...
	public static BufferedImage binarize(BufferedImage image) {
		BufferedImage grayscaledImage = toGray(image);
		return binarizeAux(grayscaledImage);
	}

	public static void writeImage(BufferedImage output, String nombre) throws IOException {
		File file = new File("C:/Users/samoel/Desktop/TestImage/" + nombre + ".jpg");
	...
	private static BufferedImage binarizeAux(BufferedImage original) {
